...
# Estado: sesión iniciada y scraping hecho
    ...
    st.title("Gráficos - Impuesto Determinado por Provincia")
    ...
    df_graficos2 = st.session_state.df_final.copy()

#======================================================CONSTRUIMOS LAS PILLS PARA PODER CAMBIAR DE VALORES Y EJES TODO EL SHOW====================================
    MODOS = {
    "Pesos Corrientes": {
        "columnas": [
            "Impuesto Determinado en millones",
            "Var_% Impuesto Determinado",
            "Índice Impuesto Determinado (Base 100)",
    ...
    "Pesos de 2025": {
        "columnas": [
            "Impuesto Determinado TR en millones",
            "Var_% Impuesto Real",
            "Índice Impuesto Real (Base 100)",
            "Ratio_Impuesto_Determinado"
        ],
        "titulos": [
...
#====================================GRAFICO 1========================================================
    ...
    # Crear figura
    fig2 = px.line(
        df_graficos2,  # Asegura que el orden se respete
        x="Año",
        y=config["columnas"][0],
        color="Jurisdicción",
        markers=True,
